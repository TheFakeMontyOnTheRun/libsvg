	...
	public static ColoredPolygon parseD(String attribute, int width, int height) {
		...
		while (pendingTokens.size() > 0) {
			...
			if (currentToken.length() > 1) {
				for (int d = 0; d < tokens.length; ++d) {
					...
					// havendo um comado, quebra o token
					if (nearer != -1) {
						// em duas partes, se estiver no
						// come������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������o
						if (nearer == 0) {
							if (currentToken.length() > 1) {
							...
							// ou em 3 partes. as partes
							// s������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������o
							// re-enfileiradas,
							// para serem reprocessadas (caso haja mais comandos
							// no meio)
			...
			// uma vez pronto e limpo, adiciona na lista de tokens puros
			brokenTokens.add(currentToken);
		}

		// para cada token puro
		while (brokenTokens.size() > 0) {
			...
			if (currentToken.charAt(0) == PATHCMD_RELATIVE_MOVE
				...
				// se for qualquer outra coisa, pode ser a
				// continua������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������o
				// implicita
				// do ultimo comando.
			} else if (currentToken.charAt(0) != PATHCMD_RELATIVE_END
					&& currentToken.charAt(0) != PATHCMD_ABSOLUTE_END) {
				// pegar os dois operandos, tal qual se fosse qualquer outra
				// coisa.
				split1 = currentToken;

				// d������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������vida:
				// como posso ter tanta certeza assim de que
				// n������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������o
				// estou
				// perdendo algum token importante aqui?
			...
			// uma tentativa tola de suportar curvas. Mas
			// ������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������
			// interessante para manter a
			// consist������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������ncia
			// no parsing.
	...
	public static Color parseColorFromStyle(String original,
		...
		if (fill.length() >= 3 && fill.substring(0, 3).equalsIgnoreCase("rgb")) {
			...
			try {
				...
				// System.out.println("failed to parse color:" + fill);
			}
